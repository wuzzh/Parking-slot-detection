...
def config_reader():
    ...
    param['img_path'] = str(param['img_path'])
    param['key_point_path'] = str(param['key_point_path'])
    param['connection_path'] = str(param['connection_path'])
    param['heatmap_path'] = str(param['heatmap_path'])
    param['heatpaf_path'] = str(param['heatpaf_path'])
